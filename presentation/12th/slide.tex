...
\centering
\includemovie[label=tegaki, controls, repeat, poster, startat=frame:1]{10mm}{10mm}{movie/tegaki.mp4}\large{手書き文字認識アプリケーション}\\

\includemovie[label=lovelive, controls, repeat, poster, startat=frame:1]{10mm}{10mm}{full_output2.mp4}\large{動画に対する顔認識}
\end{frame}
