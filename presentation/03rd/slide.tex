...
\hfill
\begin{beamercolorbox}[ center, wd=60mm, sep=2pt, shadow=false, rounded=true ]{frametitle}
 イメージを入力
\end{beamercolorbox}
\hfill\hfill
...
\hfill
\begin{beamercolorbox}[ center, wd=80mm, sep=2pt, shadow=false, rounded=true ]{frametitle}
オブジェクトを形成する不変の要素を把握
\end{beamercolorbox}
\hfill\hfill
